...
void Barcode::writeBarcodeToPos(RGBImage& image, const uint64_t barcode_num,
...
void Barcode::writeBarcodes(RGBImage& image, const uint64_t barcode_num)
{
...
std::pair<uint64_t, uint64_t> Barcode::readBarcodes(const RGBImage& image)
{
...
uint64_t Barcode::readBarcodeFromPos(const RGBImage& image,
                                      const unsigned int xpos,
                                      const unsigned int ypos)
{
